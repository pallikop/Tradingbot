...
filePath=r"D:\Trading\SnakeTrader\ReturnsOutput{}.xlsx".format(market)
...
for i in stocklist.index:
	try:
		...
		tradeCount=str(stocklist["No of Trades"][i])
		if(tradeCount=="1"):
...
newFile=os.path.dirname(filePath)+"/BestReturnsOutput{}.xlsx".format(market)
